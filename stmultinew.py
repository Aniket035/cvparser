...
SECTION_HEADERS = {
    ...
    'internship': ['Interships', 'intership',],
...
EDUCATION_KEYWORDS = [
    'b.tech', 'btech', 'bachelor', 'degree', 'graduate', 'postgraduate', 'master', 'phd', 'schooling','graduation','%',
    'cgpa', 'percentage', 'class X', 'class XII', '10th', '12th', 'ssc', 'hsc', 'intermediate', 'class', 'sgpa', 'B. Tech',
    'school', 'college', 'university', 'institute', 'engineering', 'cbse', 'icse', 'CSE', 'Intermediate',
]
...
if uploaded_files:
    for uploaded_file in uploaded_files:
        ...
        # Extract and display other sections
        extracted_data = extract_resume_sections(text)
